-- FC26 variant of the unified CareerHub export.
-- Uses the same data-access patterns as the FC25 version and should be
-- validated against FC26 Live Editor tables/helpers in-game.
...
local transfer_path = string.format("%s\\FC26-Transfers-%s-%d.json", output_dir, season.file, target_team_id)
local playerstats_path = string.format("%s\\FC26-PlayerStats-%s-%d.json", output_dir, season.file, target_team_id)
local game_path = string.format("%s\\FC26-Game-%s-%d.json", output_dir, season.file, target_team_id)
